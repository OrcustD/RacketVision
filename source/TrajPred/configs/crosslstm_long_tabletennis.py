...
custom_hooks = [
    dict(
        log_dir=
        'exp/cross_lstm/long/tabletennis/racket/b-64_l-512_n-2_lr-0.0001/vis',
        type='TrajVis'),
]
custom_imports = dict(
...
test_dataloader = dict(
    ...
    dataset=dict(
        load_path='../data/data_traj/ball_racket_tabletennis_h80_f20.pkl',
        split='test',
        type='BallTraj'),
    num_workers=0,
    pin_memory=True,
...
work_dir = 'exp/cross_lstm/long/tabletennis/racket/b-64_l-512_n-2_lr-0.0001'
